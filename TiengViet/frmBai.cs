...
namespace TiengViet
{
    public partial class frmBai : Form
    {
        ...
        private void load_listBaihoc()
        {
            ...
            {
                string[] row = { bh.Id.ToString(), bh.tieude };
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (txtID.Text != "")
            {
                ...
                MyFunction.danhsachBaihoc[idx].tieude = txtTieude.Text.Trim();
